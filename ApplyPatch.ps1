...
& {
    ...
    $idx = $testLst.Find('tests\GH_005553_regex_character_translation')
    $testLst.Insert($idx + 1, 'tests\LLVM_062056_deque_exception_safety')
    $testLst.Insert($idx + 1, 'tests\GH_005583_array_T_0')
    $testLst.Save()
}
